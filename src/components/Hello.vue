  ...
  <div>
    ...
    <div class="px-4 lg:px-6 py-2.5 mx-auto max-w-screen-lg">
      <div class="aspect-w-16 aspect-h-9 ">
        <iframe class="rounded-lg" src="https://www.youtube-nocookie.com/embed/videoseries?list=PLzZ_n8z9Sb__uXAFRUXXGJ0N1Jqvu9Fg_" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
    </div>
    <Gallery />
    <MCEmbed
      element-id="first-email-signup-form"
      url="https://donor.us20.list-manage.com/subscribe/post?u=9e1379ba4264805cb46c8968c&amp;id=c585486b2d"
      subtitle="will send you new music releases on some fridays, if you subscribe to our mailing list."
    />
    <DFooter />
...
import MCEmbed from './MCEmbed.vue';
